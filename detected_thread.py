from detector.plate_detection_v1 import LoadProcessImageThread, PlateSegmentationThread
import argparse
import configparser
import cv2
import queue
...
if __name__ == "__main__":
    ...
    img = args["image"]
    lpi = LoadProcessImageThread(img, pth_cfg, pth_weights, pth_classes, 0.5)
